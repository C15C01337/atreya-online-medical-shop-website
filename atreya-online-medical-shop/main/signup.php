                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6 col-md-4 order-2 order-md-1">
                            <form action="index.php" class="site-block-top-search">
                        ...
                        <form id="login" class="form-container" method="post">
                            ...
                            <div class="p-lg-5 border">
                                <div class="text-center">
                                    <h2 class="h3 mb-3 text-black">Please Log in!</h2>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label for="password" class="text-black">Password <span
                                                class="text-danger">*</span></label>
                                        <input type="password" id="pwd_login" name="pwd_login"
                    ...
                    <div class="col-md-5 ml-auto">
                        <div class="p-4 border mb-3">
                            ...
                            <form id="signup" class="form-container" method="post">
                                <p>Please follow the below requirement while setting the account.</p>
                                <div>
                                ...
                                <div>
                                    <label for="phone" class="text-black">Contact Number <span
                                            class="text-danger">*</span></label>
