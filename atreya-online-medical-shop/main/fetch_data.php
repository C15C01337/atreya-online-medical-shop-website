        ...
        <div class="col-md-12 text-center pagination">
            <ul class="pagination">
                ...
                <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
                    <a
                        href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1)."&query=".$search_query."&category=".urlencode($category_names); } ?>">Prev</a>
                </li>
                <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
                    <a
                        href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1)."&query=".$search_query."&category=".urlencode($category_names); } ?>">Next</a>
                </li>
                <li><a
