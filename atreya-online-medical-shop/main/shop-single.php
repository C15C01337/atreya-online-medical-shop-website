                ...
                <div class="row">
                    <form action="cart.php" method="post">
                        ...
                        <div class="col-md-6">
                            ...
                            <p><strong class="text-primary h4">$<?php echo $product_array['product_cost']; ?></strong>
                            </p>

                            <div class="mb-5">
                                <div class="input-group mb-3" style="max-width: 120px;">
                                    <div class="input-group-prepend">
                                        <button type="button" class="btn btn-outline-primary js-btn-minus"
                                            data-quantity="minus" data-field="quantity">&minus;</button>
                                    </div>
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-primary js-btn-plus" data-quantity="plus"
                                            type="button" data-field="quantity">&plus;</button>
                                    </div>
                            ...
                            <?php echo $product_array["product_id"]; ?>
                            <p><button type="submit" id="pass-url" onclick="geturl()"
