...
<body>
    ...
    <div class="site-wrap">
        ...
        ?>
			...
			// Create connection
			$con = new mysqli($servername, $username, $password, "medical_db");
			...
			?>
                                    <tr>
                                        <td class="product-thumbnail">
                                            <img src="admin/product_images/<?php echo $product_array['product_image']; ?>"
                                                alt="Image" class="img-fluid" width="150" height="150">
                                        </td>
                                            ...
                                            <div class="product-thumbnail">
                                                <div class="input-group mb-3" style="max-width: 120px;">
                                                    ...
                                                    <input class="form-control text-center"
                                                        name="quantity-<?php echo $product_array["product_id"];?>"
                                                        value=<?php echo $product_array["quantity"]; ?> placeholder="">
                                                    <input type="hidden"
                                                        name="product_count-<?php echo $product_array["product_id"];?>"
                                                        value="<?php echo $product_array["product_count"];?>" />
                                                    <input type="hidden"
                                                        name="product_id-<?php echo $product_array["product_id"];?>"
                                        ...
                                        <td><?php echo "$";echo $product_array["quantity"]*$product_array['product_cost']; $cart_total+=$product_array["quantity"]*$product_array['product_cost'] ?>
                                        </td>
                                        <td><a href="#" class="btn btn-primary btn-sm"
                                                onClick="removeProduct(<?php echo $product_array["product_id"] ?>)">X</a>
                                        </td>
                                    </tr>
                                    <?php
					}
			...
			?>
                    ...
                    <div class="col-md-6">
                        <div class="row mb-5">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <button class="btn btn-primary btn-sm btn-block" onClick="updateCart()">Update
                                    Cart</button>
                            </div>
                            <div class="col-md-6">
                ...
                jQuery(document).ready(function() {
                    ...
                    $('[data-quantity="plus"]').click(function(e) {
                        ...
                        var max_count = currentVal + parseInt($('input[name=product_count-' +
                            fieldName + ']').val());
                        ...
                        if (!isNaN(currentVal)) {
                            ...
                            if (currentVal + 1 <= max_count) {
                                ...
                                $('input[name=product_count-' + fieldName + ']').val(max_count -
                                    currentVal - 1);
                            } else
                    ...
                    $('[data-quantity="minus"]').click(function(e) {
                        ...
                        // Get its current value
                        var currentVal = parseInt($('input[name=quantity-' + fieldName + ']').val());
                        var max_count = parseInt($('input[name=product_count-' + fieldName + ']')
                            .val());
